...
This post is essentially just to outline how I plan to Arabic transliteration throughout my blog posts *in shā allāh*. All letters will have unique English transliterations; primarily using 1 letter however some will use two letters which are: ث خ ذ ش غ
